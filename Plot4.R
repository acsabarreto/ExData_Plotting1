...
png("plot4.png")
par(mfrow=c(2,2))
with(holding, plot(DateTime, Global_active_power, type = "l", xlab = "", ylab = "Global Active Power"))
with(holding, plot(DateTime, Voltage, type = "l", xlab = "datetime", ylab = "Voltage"))
...
with(holding, plot(DateTime, Global_reactive_power, type = "l", xlab = "datetime"))
dev.off()